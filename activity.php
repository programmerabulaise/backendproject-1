...
<html lang="en">
  ...
  <div class="container" style="width:1140px; margin:auto;"> 
     ...
     <div class="row pt-5">
       <div class="col-sm-6">
         <div class="userimg">
         <img style ="width:200px; height:200px;" src="images/<?php echo $profileimg;?>" alt="uplaod your profile picture"> 
            <div class="uploadfile pt-3">
            <form action="Profile_img_upload_coro.php" method="POST" enctype="multipart/form-data">
       ...
       <div class="col-sm-6 " style="display:flex;">
         <a   style="padding-right:20px; margin-top:10px; font-size:15px"  href="changepassword.php">change passowrd</a>
         <?php  if(isset($_REQUEST["password"])){ ?>

        <h4 style="color:green; padding-top:2px; float:left;"><?php echo"password successfully changeed";?></h4>
